            ...
            <Col key={index} xs={12} md={6} lg={4}>
              <Card>
                <Card.Img
                  ...
                  alt=""
                  src="https://media.istockphoto.com/id/1633187476/photo/face-of-a-business-black-woman-proud-and-happy-with-company-values-mission-and-inclusion.jpg?s=612x612&w=0&k=20&c=V8fpscDMx2iBGWGvpJx4jDSaUBmjLAR0pKTLiRy9EBc="
                />
                <Card.Body>
                  <Card.Title>
                    {course.name}{" "}
