...
import pictureofme from "../images/Ezike.jpeg";

function AboutPage() {
  return (
    <div className="about">
      <h1 className="about-h1">About this Site</h1>
      <h5 className="about-h5">Created by: Christopher Ezike</h5>
      <h4 className="about-h4">Senior Frontend Developer</h4>
      <a
        href="https://www.linkedin.com/in/christopherezike/"
        target="_blank"
        rel="noreferrer"
      >
        <AiOutlineLinkedin id="linkedin" />
      </a>{" "}
      <a href="https://github.com/EzikeChris" target="_blank" rel="noreferrer">
